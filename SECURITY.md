# Security Policy for Tic Tac Fusion

## Supported Versions

We actively release security and stability patches for the following versions of **Tic Tac Fusion**:
...
We take the security and integrity of **Tic Tac Fusion** and its build/installer distribution seriously.

If you discover a security vulnerability (e.g., in binary packaging, installer privilege escalation, dependency vulnerability, or file serialization in `%APPDATA%`), please report it privately:
...
- A proof of concept (PoC) or script (if available).
- Impact assessment.
